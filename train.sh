...
# SwAV (メモリ使用量が多い)
#python3 main.py --method swav    --dataset cifar10 --data_dir /workspace/data/cifar10

# MAE (メモリ使用量が多い)
#python3 main.py --method mae     --dataset cifar10 --data_dir /workspace/data/cifar10 --batch_size 256 --max_epochs 200